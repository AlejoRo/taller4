...
public class Servlet4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            CuentaBancaria cuenta = banco.getCuentas().get(Integer.parseInt(varcuenta));
            
            if (formulario.equals("todosmovimientos")) {
                if (cuenta.getMovimientos() != null) {
                    
//                   
//                    
//                    List<CuentaBancaria> cuentas;
//                    cuentas = new ArrayList<CuentaBancaria> (banco.getCuentas().values());
//                    
...
//                    request.setAttribute("min", minbal);
                    ...
                    request.setAttribute("mensaje", "No se han realizado movimientos");
                }
